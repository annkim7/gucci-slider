    ...
    $.fn.qnaSlider = function(options){
        var qnaSlider = {
            init: function(el){
                ...
                this.slideAngle = 210 / this.$slides.length;
            ...
            handleDragEnd: function(e){
                ...
                if(this.currentlyDragging){
                    ...
                    /*크기 & 버튼 등장*/
                    var qnaCircle = $(".qna_bg");

                    for(var i=0;i<qnaCircle.length;i++){
                        var qnaI = -(this.slideAngle * (i-11));

                        if(this.currentRotationAngle == qnaI){
                            $(".qna_bg").css({transform: 'scale(1.3)'});
                            $(".qna_bg").eq(i).css({transform: 'scale(1)'});

                            $(".qna-slider li").removeClass("swipe");
                            $(".qna-slider li").eq(i).addClass("swipe");
                        }
                    }
            ...
            renderSlider: function(){
                ...
                var $slide = $(el);
                    ...
                    $slide.css('transform', 'translateX(-50%) rotate('+this.slideAngle * (i-11) +'deg) translateY(-'+ upperArcHeight +'px)');
            ...
            rotate: function(){
                ...
                this.rotateTimeoutId = setTimeout(function(){
                    ...
                    if(this.currentRotationAngle >= 105){
                        this.currentRotationAngle = 105;
                        this.$slidesContainer.css('transform', 'translateX(-50%) rotate('+this.currentRotationAngle+'deg)');
                    }else if(this.currentRotationAngle <= -96){
                        this.currentRotationAngle = -96;
                        this.$slidesContainer.css('transform', 'translateX(-50%) rotate('+this.currentRotationAngle+'deg)');
                    }
            ...
            validateMarkup: function(){
                if(
                    this.$slider.hasClass('qna-slider') &&
